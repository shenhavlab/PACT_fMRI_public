...
#SBATCH -J rdm-lvl1Cat_pt
#SBATCH --output logs/rdm-lvl1Cat_%A-%a.txt
#SBATCH --array=4-32
...
# do level 1
matlab-threaded –nodisplay -nodesktop -r "RDM_wholeBrain_1_1_estimateCat('${root_dir}','${spm_dir}', ${ptNum}, '${name}', ${fwhm}, '${confound}', '${cvi}');"
