...
#SBATCH -J rdm-exractVOI_pt
#SBATCH --output logs/rdm-exractVOI_%A-%a.txt
#SBATCH --array=4-32
...
# do level 1
matlab-threaded –nodisplay -nodesktop -r "RDM_PPI_1_1_extractVOI('${root_dir}','${spm_dir}', ${ptNum}, '${name}', ${fwhm}, '${confound}', '${cvi}');"
